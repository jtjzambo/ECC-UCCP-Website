        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {historyData.localHistory.content.map((section, index) => (
              <div key={index} className="bg-gradient-to-br from-slate-50 to-emerald-50 rounded-2xl p-8 border border-emerald-100 hover:shadow-lg transition-shadow duration-300">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">
              {historyData.uccpOverview.title}
            </h2>
            <p className="text-xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
              {historyData.uccpOverview.subtitle}
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-3xl font-bold text-slate-800">
                {historyData.uccpOverview.history.title}
              </h3>
            </div>
            <p className="text-lg text-slate-600 leading-relaxed">
              {historyData.uccpOverview.history.content}
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg mb-12">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-3xl font-bold text-slate-800">
                {historyData.uccpOverview.values.title}
              </h3>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              {historyData.uccpOverview.values.items.map((value, index) => (
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-3xl font-bold text-slate-800">
                {historyData.uccpOverview.theological.title}
              </h3>
            </div>
            <p className="text-lg text-slate-600 leading-relaxed mb-6">
              {historyData.uccpOverview.theological.content}
            </p>
            <ul className="space-y-3">
              {historyData.uccpOverview.theological.principles.map((principle, index) => (
              ...
              {filteredEvents.map((event, index) => (
                ...
                >
                  ...
                  <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                    <div className="bg-gradient-to-br from-slate-50 to-emerald-50 rounded-2xl p-6 border border-emerald-100 hover:shadow-xl transition-shadow duration-300">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {historyData.photoSuggestions.map((photo) => (
              <div key={photo.id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
